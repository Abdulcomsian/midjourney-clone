          ...
          <div className="d-flex flex-column m-2 w-100 ">
            <div className="border p-4 rounded-4  ">
              <div class="text-container text-center">
                <h2 class="mt-5 mb-3 fw-bold text-secondary">
                  Payment Initialization Successful !
                </h2>
                <p className="text-secondary">
                  Thank you for select the available payment method and
                  initialize the payment.
                </p>
                <p className="text-secondary">
                  Your premium subsription will expire on Decmeber, 2024
                </p>
              </div>
              ...
              <button className="btn btn-buy" onClick={handleRedirect}>
