                    ...
                    <div className="d-flex grid  ">
                        ...
                        <div className='d-flex flex-column m-2 w-100 '>
                            ...
                            <div className='border p-4 rounded-4  '>
                                ...
                                <h6 className='fw-bold text-secondary mt-4'>Remaining Fast hours:</h6>

                                <div class="text-container">
                                    <div className="d-flex justify-content-between">
                                        <div className='text-secondary'>include</div>
                                        <div className='text-secondary'>{subscription.currency_code}</div>
                                    </div>
                                    <div className="d-flex justify-content-between">
                                        <div className='text-secondary'>Purchaseh & Awarded</div>
                                        <div className='text-secondary'>{subscription.subscription_amount}</div>
                                    </div>
                                </div>
                                ...
                                <p className='off-text text-secondary'>Your subscription is active until <span className='ml-4'>{new Date(subscription.end_date).toLocaleDateString()}</span></p>
                            ...
                            <ul className='list-unstyled text-secondary pt-4'>
                                {Array.isArray(subscription.subscription_tier?.features)
                                    ? subscription.subscription_tier?.features.map((feature, index) => (
                                        <li key={index}><span className="text-success">✔</span> {feature}</li>
                                    ))
