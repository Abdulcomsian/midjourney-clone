        ...
        <Popover id="popover-basic" rootClose="false">
            <Popover.Body className='p-1'>
                <ul className='list-unstyled'>
                    <li>
                        <a href='/my-profile' className='d-flex align-items-center gap-2 p-2 text-dark text-decoration-none rounded-5'>
                            <span className='icon'>
            ...
            <Popover.Body className='p-2'>
                <ul className='list-unstyled'>
                    {isAuthenticated &&
                        <>
                            <li>
                                <a href='/my-subscription' className='d-flex align-items-center gap-2 p-2 text-dark text-decoration-none rounded-5'>
                                    <span className='icon'>
            ...
            <section className='sidebar pt-3 flex-column position-fixed d-flex'>
                <div className='top-nav grow d-flex flex-column gap-3'>
                    ...
                    <ul className='list-unstyled d-flex flex-column gap-2'>
                        <li>
                            <a href='/' className={`d-flex align-items-center gap-2 p-2 rounded-5 ${isActive('/')}`}>
                                <span className='icon'>
                                ...
                                <span className='link-name'>{t?.NavigationTitle_2 || "Discover"}</span>
                            </a>
                        </li>
                        {isAuthenticated && <li>
                            <a className='d-flex align-items-center gap-2 p-2 rounded-5'>
                                ...
                                <span className='link-name'>{t?.NavigationTitle_3 || "My Images"}</span>
                            </a>
                        </li>}
                        {isAuthenticated &&
                            <li>
                                <a className='d-flex align-items-center gap-2 p-2 rounded-5'>
                                    ...
                                    <span className='link-name'>{t?.NavigationTitle_4 || "My Videos"}</span>
                                </a>
                            </li>
                        }
                        <li>
                            ...
                            <a href='/update' className={`d-flex align-items-center gap-2 p-2 rounded-5 ${isActive('/update')}`}>
                                ...
                                <span className='link-name'>{t?.NavigationTitle_5 || "Use Cases"}</span>
                            </a>
                        </li>
                    ...
                    <ul className='list-unstyled d-flex flex-column gap-2'>
                        {isAuthenticated &&
                            <li>
                                ...
                                <a href='/subscription' className={`d-flex align-items-center gap-2 p-2 rounded-5 ${isActive('/update')}`}>
                                    <span className='icon'>
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" fill="currentColor" width="22" height="22" stroke="none" strokeWidth="2">
                                            <circle cx="32" cy="24" r="14" fill="none" stroke="black" strokeWidth="2" />
                                            <line x1="32" y1="28" x2="32" y2="38" stroke="black" strokeWidth="2" />
                        ...
                        <li>
                            <a href='/help' className={`d-flex align-items-center gap-2 p-2 rounded-5 ${isActive('/help')}`}>
                                <span className='icon'>
                                ...
                                <span className='link-name'>{t?.NavigationTitle_6 || "FAQ"}</span>
                            </a>
                        </li>
                        <li>
                            <OverlayTrigger trigger='click' rootClose placement="right" overlay={popoverTheme}>
                                <a className='d-flex align-items-center gap-2 p-2 rounded-5'>
                                    ...
                                    <span className='link-name'>{darkThemeMode ? `${t?.Mode_2 || "Dark Mode"}` : `${t?.Mode_1 || "Light Mode"}`}</span>
                                </a>
                            </OverlayTrigger>
                        </li>
                            ...
                            <>
                                ...
                                <li>
                                    ...
                                    <a className='d-flex align-items-center gap-2 p-2 rounded-5'>
                                        ...
                                        <span className='link-name' onClick={handleLogout}>{t?.NavigationTitle_9 || "Logout"}</span>
