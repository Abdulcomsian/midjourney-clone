          ...
          <ul className="list-unstyled p-3 d-flex w-100 gap-2">
            <li className="flex-1">
              <button className="w-100 border py-2 bg-transparent rounded-1 text-start opacity-75">
                <a
                  href="/update"
                  className="d-flex align-items-center gap-2 p-2 rounded-5 fs-6"
                >
                  <span className="icon">
                    <svg
            ...
            {!showMenu ? (
              ...
              <span className="icon">
                ...
                >
                  ...
                  >
                    {" "}
                    <path d="M137 363 c-12 -12 -7 -21 37 -64 l51 -49 -51 -49 c-44 -43 -49 -52 -37 -64 12 -12 21 -7 63 37 l49 51 50 -49 c42 -41 52 -47 65 -37 13 11 8 20 -37 62 l-52 49 52 49 c45 42 50 51 37 62 -13 10 -23 4 -65 -37 l-50 -49 -49 51 c-42 44 -51 49 -63 37z" />{" "}
                  </g>{" "}
                </svg>
              </span>
            )}
            ...
            >
              <span className="icon">
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M11.999 2C6.486 2 2 6.486 2 12c0 5.514 4.486 10 9.999 10 5.514 0 10.001-4.486 10.001-10C21.999 6.486 17.513 2 11.999 2zM4 12c0-4.418 3.584-8 8-8 4.418 0 8 3.584 8 8 0 4.416-3.584 8-8 8-4.416 0-8-3.584-8-8z"
                    clipRule="evenodd"
                  ></path>
                  <path d="M12 13a1.999 1.999 0 110-3.999A2 2 0 0112 13zm0 7c2.21 0 4-1.79 4-3.999h-8c0 2.21 1.791 3.999 4 3.999z"></path>
                </svg>
              </span>
