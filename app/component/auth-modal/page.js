    ...
    onSuccess: (codeResponse) => {
      fetch(`https://www.googleapis.com/oauth2/v1/userinfo?access_token=${codeResponse.access_token}`, {
        ...
        .then(async (data) => {
          ...
          try {
            const result = await registerGoogleUser(data); // Call the register API
      ...
      <Modal.Body className='custom-input'>
        <Form onSubmit={handleLogin}>
          ...
          <div className='d-flex gap-3 justify-content-center py-3'>
            <Button onClick={login} className="border btn mb-3 p-2 w-100 bg-transparent text-dark d-flex justify-content-center gap-2 align-items-center fs-14">
