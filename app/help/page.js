...
function Help() {
  ...
  const resourcesArray = [
    {
      resourceName: "Getting Started",
      sulg: "A quick how-to guide to get you started making images as fast as possible",
    },
    {
      resourceName: "In-Depth Documentation",
      sulg: "A quick how-to guide to get you started making images as fast as possible",
    },
    {
      resourceName: "Create with Newcomers",
      sulg: "A quick how-to guide to get you started making images as fast as possible",
    },
    {
    ...
    {
      resourceName: "Prompt Crafting Chatroom",
      sulg: "A quick how-to guide to get you started making images as fast as possible",
    },
    {
      resourceName: "Billing Support",
      sulg: "A quick how-to guide to get you started making images as fast as possible",
    },
  ];
  const add = () => {
  ...
  const remove = (i) => {
    setAffectedUrl((prevRowList) =>
      prevRowList.filter((_, index) => index !== i)
    );
  };
          ...
          <div className="left-panel">
            <div className="frequently-question">
              <h2 className="text-center fw-600">
                {t?.Faq.Heading || "Frequently Asked Question"}
              </h2>
            ...
            <Accordion className="my-5">
              <Accordion.Item eventKey="0" className="mb-2 rounded-3">
                <Accordion.Header className="border-0">
                  {t?.Faq.faq1 || "What are Fast Hours?"}
                </Accordion.Header>
                <Accordion.Body>
                  <p className="mb-4">
                    {t?.Faq.answer1 ||
                      "We have two modes for image generation, “fast” and “relax”.Fast tries to give you a GPU instantly. It's our highest priority processing tier, and it's kinda expensive. Relax puts you in a queue behind others based on how much you've used the system in relax mode."}
                  </p>
                  {/* <p className="mb-4">
                    The basic plan comes with 200 fast GPU-minutes/mo, standard
                    with 15 fast gpu-hours/mo, and pro with 30 gpu-hours/mo.
                  </p>
                  <p className="mb-4">
                    One hour is roughly 60 image generation or upscale commands
                    and roughly 200 image variation commands.
                  </p>
                  <p className="mb-4">
                    These numbers are experimental and may change at any time.
                  </p> */}
                </Accordion.Body>
              </Accordion.Item>
              <Accordion.Item eventKey="1" className="mb-2 rounded-3">
                <Accordion.Header className="border-0">
                  {t?.Faq.faq2 || "What is unlimited relaxed generation?"}
                </Accordion.Header>
                <Accordion.Body>
                  <p className="mb-4">
                    {t?.Faq.answer2 ||
              ...
              <Accordion.Item eventKey="2" className="mb-2 rounded-3">
                <Accordion.Header className="border-0">
                  {t?.Faq.faq3 || "What if I want MORE fast?"}
                </Accordion.Header>
                <Accordion.Body>
                  <p className="mb-4">
                    {t?.Faq.answer3 ||
              ...
              <Accordion.Item eventKey="3" className="mb-2 rounded-3">
                <Accordion.Header className="border-0">
                  {t?.Faq.faq4 || "What is the Community Gallery?"}
                </Accordion.Header>
                <Accordion.Body>
                  <p className="mb-4">
              ...
              <Accordion.Item eventKey="5" className="mb-2 rounded-3">
                <Accordion.Header className="border-0">
                  {t?.Faq.faq6 || "How does commercial use work?"}
                </Accordion.Header>
                <Accordion.Body>
                  <p className="mb-4">
                    {t?.Faq.answer6 ||
