                    ...
                    {images.map((item,index) => (
                        <TabScreen key={index} index={index} activeTab={activeTab}>
                            <div className="img-data">
                                <p>{item.slug} 17h</p>
                                <p className='my-3'>black cat sitting on an open book, surrounded by candles and spell books, in the background is grey wallpaper, fantasy art style painting</p>
